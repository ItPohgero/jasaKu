<header class="sticky top-0 z-10 py-2 bg-gray-200 dark:bg-gray-800">
        ...
        <div class="flex flex-1 justify-center">
            <div class="relative w-full max-w-xl mr-3 focus-within:text-yellow-500">
                <form action="{{ route('search') }}" method="get">
                    ...
                    <select name="keyword"
                        class="w-full md:py-3 pl-10 text-sm text-gray-700 placeholder-gray-600 bg-white border-0 rounded-full dark:placeholder-gray-500 dark:focus:shadow-outline-gray dark:focus:placeholder-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:placeholder-gray-500 focus:bg-white focus:border-yellow-300 focus:outline-none focus:shadow-outline-yellow form-input">
