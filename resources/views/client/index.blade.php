<x-client-layout>
    <div
        class="rounded-lg bg-gray-300 text-white p-8 mb-3 mx-3 flex flex-col md:flex-row space-between items-center justify-between relative overflow-hidden">
        <!-- LEFT PART -->
        ...
        <div class="pt-8 md:pt-0 justify-center lg:ml-auto z-10">
            ...
            <a href="#" target="_blank" download
                class="flex items-center px-8 py-4 text-center text-sm text-gray-300 uppercase bg-white font-display rounded-full transition duration-200 hover:bg-gray-600 hover:text-white">
        ...
        <!-- DÉCORATION -->
        <div
            class="absolute bg-gray-400 opacity-60 w-96 h-96 -top-10 -right-16 md:w-[800px] md:h-[800px] md:left-[45%] md:top-[-150%] rounded-full shadow-2xl z-0">
        </div>
    </div>
</x-client-layout>