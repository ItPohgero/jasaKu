<x-worker-layout>
    ...
    <div class="my-3 bg-white flex justify-center items-center p-3 rounded-lg shadow-lg text-xs font-bold">
    ...
    <div class="grid grid-cols-2 gap-3 text-xs">
        ...
        <div class="bg-white flex justify-center items-center p-3 rounded-lg shadow-lg">
            <div class="block">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mx-auto mb-2 text-green-500" viewBox="0 0 20 20"
                    fill="currentColor">
                    <path fill-rule="evenodd"
                ...
                <div>
                    {{ \App\Models\SkillUser::whereUser_id(worker()->user_id)->count() }}
                    Skill dikuasai
                </div>
            </div>
        </div>
